...
'''
We can see in 2019, our K-Band trading strategy worked well for ISF.L, which is ETF for the FTSE 100 index. We had an annual 
return of 41.3% comparing with the buy and hold 14.25%. From the chart we, we can feel the trading strategy we have is not too volatile.
'''
...
In total, we have 21 trades, 11 long and 10 short. All long trades yield positive returns and 80% of the short trades getting us wins. 
Due to the 2 loss trades of short, the average return of short trades is lower than long trades and the standard deviation is higher 
than long trades. However, within short trades, the average return of the winning trades is larger than the average loss, so in general, 
the signal is good for short trades too.
'''